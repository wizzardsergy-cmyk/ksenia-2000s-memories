const FlowerDecoration = () => {
  return (
    <>
      ...
      <div className="decorative-hearts z-0">
      ...
      <div className="decorative-stars absolute inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <div className="decorative-smiles absolute inset-0 pointer-events-none overflow-hidden opacity-20 z-0">
